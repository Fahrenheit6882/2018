...
/**
 * Creates a transmission for a 6 wheel drop center robot with 2 motors per side.
 * @param left1
 * @param left2
 * @param right1
 * @param right2
...
/**
 * Drive the robot.
 * @param speedLeft Range of values: -1 (full reverse) to +1 (full forward)
 * @param speedRight Range of values: -1 (full reverse) to +1 (full forward)
 */
 ...
 * @param button - indicates the state of the button
 */
