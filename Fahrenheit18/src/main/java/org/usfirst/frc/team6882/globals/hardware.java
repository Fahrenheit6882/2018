...
public class hardware {
	...
	//commented out because it is not compatible
	//public static WPI_TalonSRX liftTalon = new WPI_TalonSRX(0);
	public static TalonSRX  liftTalon = new TalonSRX(0);
	...
	public static Manipulators manipulators = new Manipulators(liftTalon, intakeSparkLeft, intakeSparkRight, flipper1, flipper2);
